...
export default class VRTourApp extends React.Component {
  render() {
    return (
      <View>
        <Image source={asset('house.png')} style={{width: 500, height: 300}} />
        <View style={styles.attractionBox}>
          <VrButton onClick={() => surfaceModule.start()}>
            <Text style={styles.attractionText}>
              Welcome to Beautiful Homes! Click Here!
            </Text>
          </VrButton>
        </View>
      </View>
...
AppRegistry.registerComponent('VRTourApp', () => VRTourApp);
